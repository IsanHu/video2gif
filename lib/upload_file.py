...
class uploadfile():
    def __init__(self, name, type=None, size=None, not_allowed_msg=''):
        ...
        self.url = "unprocessed/%s" % name
        self.delete_url = "deleteunprocessed/%s" % name
...
class processedfile():
    def __init__(self, name, type=None, size=None, not_allowed_msg=''):
        ...
        self.size = size
        self.not_allowed_msg = not_allowed_msg
        self.url = "processed/%s" % name
        self.delete_url = "deleteprocessed/%s" % name
        self.delete_type = "DELETE"
...
class zipedgiffile():
    def __init__(self, name, type=None, size=None, not_allowed_msg=''):
        ...
        self.size = size
        self.not_allowed_msg = not_allowed_msg
        self.url = "zipedgif/%s" % name
        self.delete_url = "deletezipedgif/%s" % name
        self.delete_type = "DELETE"
